    ...
    <div className={styles.containerHowItWork}>
      ...
      <div className={styles.containerIconsSection}>
        <div className={styles.iconsSection}>
          ...
          <div className={styles.textIcon}>1. Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
        </div>
        <div className={styles.iconsSection}>
          <div className={styles.icon}>
            <ApartmentIcon />
          </div>
          <div className={styles.textIcon}>2. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
        </div>
        <div className={styles.iconsSection}>
          <div className={styles.icon}>
            <ApartmentIcon />
