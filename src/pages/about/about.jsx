...
function About() {
  ...
  return (
    <div className={styles.containerAbout}>
      ...
      <Footer />
      <Modal open={modalState} close={() => setModalState(false)} footer={false} header={false}>
        <ModalExperience title="titulo del modal" dataExperience={arrayExperiences} />
      </Modal>
    </div>
  );
}
